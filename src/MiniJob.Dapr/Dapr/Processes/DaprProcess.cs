        ...
        where TOptions : Options.DaprProcessOptions, new()
{
    ...
    public bool Start(Func<DaprOptions> optionsAccessor, CancellationToken cancellationToken = default)
    {
    ...
    private void Initialize(CancellationToken cancellationToken)
    {
        try
        {
            ...
            else
            {
                ...
                _restartTimer.Elapsed += (sender, args) => Restart(CancellationToken.None);
            }
    ...
    private IProcess StartManagedProcess(TOptions proposedOptions, CancellationToken cancellationToken)
    {
