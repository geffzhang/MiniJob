...
/// </remarks>
internal sealed class BlankDayOfMonthOrWeekParser : CronParserBase
{
    /// <summary>
    ///  构造函数
    /// </summary>
    ...
    public BlankDayOfMonthOrWeekParser(CrontabFieldKind kind)
    {
        ...
        {
            throw new CronExpressionException("The <?> parser can only be used in the Day-of-Week or Day-of-Month fields.");
        }
