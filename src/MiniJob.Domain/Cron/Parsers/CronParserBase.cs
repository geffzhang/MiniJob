...
internal abstract class CronParserBase : ICronParser
{
    public CrontabFieldKind Kind { get; set; }
    ...
    internal static int ToCronDayOfWeek(DayOfWeek dayOfWeek)
    {
    ...
    /// <returns></returns>
    internal static DayOfWeek ToDayOfWeek(int dayOfWeek)
    {
