...
{
    [DbContext(typeof(MiniJobDbContext))]
    partial class MiniJobDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniJob.Jobs.AppInfo", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("MiniJobAppInfo", (string)null);
                });

            modelBuilder.Entity("MiniJob.Jobs.JobInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ExecutorInfo")
                        .HasMaxLength(256)
                    ...
                    b.Property<double>("MinDiskSpace")
                        .HasColumnType("float");

                    b.Property<double>("MinMemorySpace")
                        .HasColumnType("float");

                    b.Property<byte>("MisfireStrategy")
                    ...
                    b.ToTable("MiniJobJobInfo", (string)null);
                });

            modelBuilder.Entity("MiniJob.Jobs.JobInfoIdentityUser", b =>
                {
                    ...
                    b.HasKey("JobInfoId", "UserId");

                    b.HasIndex("UserId");

                    b.HasIndex("JobInfoId", "UserId");

                    b.ToTable("MiniJobJobInfoIdentityUser", (string)null);
                });

            modelBuilder.Entity("MiniJob.Jobs.JobInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InstanceArgs")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");
                    ...
                    b.ToTable("MiniJobJobInstance", (string)null);
                });

            modelBuilder.Entity("MiniJob.Jobs.ProcessorInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsBuiltInExecutor")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("MiniJobProcessorInfo", (string)null);
                });

            modelBuilder.Entity("MiniJob.Jobs.WorkerInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MiniJobWorkerInfo", (string)null);
                });
            ...
            modelBuilder.Entity("MiniJob.Jobs.JobInfoIdentityUser", b =>
                {
                    b.HasOne("MiniJob.Jobs.JobInfo", null)
                        .WithMany("AlarmUsers")
            ...
            modelBuilder.Entity("MiniJob.Jobs.JobInstance", b =>
                {
                    b.HasOne("MiniJob.Jobs.JobInfo", "JobInfo")
