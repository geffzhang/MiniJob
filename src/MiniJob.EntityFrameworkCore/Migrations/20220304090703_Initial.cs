    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                AppName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_MiniJobAppInfo", x => x.Id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                JobName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                Description = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                JobArgs = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                ...
                TimeExpressionValue = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                ...
                ExecutorInfo = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                MaxInstanceCount = table.Column<int>(type: "int", nullable: false),
                ...
                IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                MisfireStrategy = table.Column<byte>(type: "tinyint", nullable: false),
                MinCpuCores = table.Column<double>(type: "float", nullable: false),
                MinMemorySpace = table.Column<double>(type: "float", nullable: false),
                MinDiskSpace = table.Column<double>(type: "float", nullable: false),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_MiniJobJobInfo", x => x.Id);
            });

        migrationBuilder.CreateTable(
            name: "MiniJobProcessorInfo",
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                FullName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                WorkerName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                Tags = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                IsBuiltInExecutor = table.Column<bool>(type: "bit", nullable: false),
                IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_MiniJobProcessorInfo", x => x.Id);
            });

        migrationBuilder.CreateTable(
            name: "MiniJobWorkerInfo",
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                Address = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                ...
                CpuUsed = table.Column<double>(type: "float", nullable: false),
                MemoryUsed = table.Column<double>(type: "float", nullable: false),
                MemoryTotal = table.Column<double>(type: "float", nullable: false),
                DiskUsed = table.Column<double>(type: "float", nullable: false),
                DiskTotal = table.Column<double>(type: "float", nullable: false),
                ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_MiniJobWorkerInfo", x => x.Id);
            });
        ...
        migrationBuilder.CreateTable(
            name: "MiniJobJobInfoIdentityUser",
            columns: table => new
            {
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_MiniJobJobInfoIdentityUser", x => new { x.JobInfoId, x.UserId });
                table.ForeignKey(
                    name: "FK_MiniJobJobInfoIdentityUser_AbpUsers_UserId",
                    column: x => x.UserId,
                    principalTable: "AbpUsers",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_MiniJobJobInfoIdentityUser_MiniJobJobInfo_JobInfoId",
                    column: x => x.JobInfoId,
                    principalTable: "MiniJobJobInfo",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
            });

        migrationBuilder.CreateTable(
            name: "MiniJobJobInstance",
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                InstanceArgs = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                ...
                ActualTriggerTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_MiniJobJobInstance", x => x.Id);
                table.ForeignKey(
                    name: "FK_MiniJobJobInstance_MiniJobJobInfo_JobInfoId",
                    column: x => x.JobInfoId,
                    principalTable: "MiniJobJobInfo",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateIndex(
            name: "IX_MiniJobJobInfoIdentityUser_JobInfoId_UserId",
            table: "MiniJobJobInfoIdentityUser",
            columns: new[] { "JobInfoId", "UserId" });

        migrationBuilder.CreateIndex(
            name: "IX_MiniJobJobInfoIdentityUser_UserId",
            table: "MiniJobJobInfoIdentityUser",
            column: "UserId");

        migrationBuilder.CreateIndex(
            name: "IX_MiniJobJobInstance_JobInfoId",
            table: "MiniJobJobInstance",
            column: "JobInfoId");
    }
